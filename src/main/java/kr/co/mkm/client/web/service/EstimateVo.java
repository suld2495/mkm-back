...
public class EstimateVo {
    ...
    private String pallettrack;
    private String lightweightrack;
    private String box;
    ...
    public String getPallettrack() {
        return pallettrack;
    }

    public void setPallettrack(String pallettrack) {
        this.pallettrack = pallettrack;
    }

    public String getLightweightrack() {
        return lightweightrack;
    }

    public void setLightweightrack(String lightweightrack) {
        this.lightweightrack = lightweightrack;
    }
